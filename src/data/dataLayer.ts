  ...
  if (getDeliverables().length === 0) {
    const sampleDeliverables: Deliverable[] = [
      ...
      },
      {
        ...
        description: 'Build reusable React component library with TypeScript',
        workstreamId: '1',
        ownerId: '1',
        status: 'In Progress',
        priority: 'High',
      ...
      },
      {
        ...
        description: 'Configure automated testing and deployment pipelines',
        workstreamId: '3',
        ownerId: '1',
        status: 'In Progress',
        priority: 'Medium',
      ...
      },
      {
        ...
        description: 'Analyze and optimize application performance metrics',
        workstreamId: '2',
        ownerId: '1b',
        status: 'In Progress',
        priority: 'High',
